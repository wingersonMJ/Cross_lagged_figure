...
# Load data
df = pd.read_excel("C:\\Users\\wingersm\\OneDrive - The University of Colorado Denver\\Desktop\\Python Projects\\16.0 Ross_cross_lag\\Cross-lagged sleep_activity\\crosslag_sleep_pa.xlsx", sheet_name="Final_dat")
...
plt.tight_layout()
plt.savefig("C:\\Users\\wingersm\\OneDrive - The University of Colorado Denver\\Desktop\\Python Projects\\16.0 Ross_cross_lag\\Figure_1.jpg", dpi=300, bbox_inches='tight')
plt.show()

# testing out branches in git within VSCode. Kinda neat...
