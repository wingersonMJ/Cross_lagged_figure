...
# Load data
df = pd.read_excel("../Cross-lagged sleep_activity/crosslag_sleep_pa.xlsx", sheet_name="Final_dat")
...
axes[0].set_ylabel("Average MVPA (minutes/day)", fontsize=12)
...
axes[1].set_xticklabels(["Early WASO", "Later WASO"], fontsize=10)
axes[1].set_ylabel("Average WASO (minutes/night)", fontsize=12)
...
plt.tight_layout()
plt.savefig("./Figure_1.jpg", dpi=300, bbox_inches='tight')
plt.show()